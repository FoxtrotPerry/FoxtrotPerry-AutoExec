...
2. Use these launch options if you want:
-novid -high -freq [WHATEVER YOUR REFRESH RATE IS] -threads 4 -console +exec autoexec -steam -noforcemparms -noforcemaccel -noforcemspd -processheap -tickrate 64 +rate 128000 -nod3d9ex1 +mat_queue_mode 2 -language custom
 *These have worked for me and continue to work for me today but ymmv*
3. Launch CS:GO
